...
Furniture looked like a weak category on paper, but the margin problem wasn't really about Furniture — it was about discounting. About 9% of order lines across the whole dataset had a discount of 50% or more, and those lines alone accounted for roughly a quarter of all profit lost. Furniture just happened to have more of them than other categories. The margin gap between Furniture and Technology held up under a statistical test (p < 0.000001), Tables came out as the single worst sub-category (actually losing money, not just low-margin), and Central region's Furniture line was the only region+category combination in the business that was unprofitable outright. The practical takeaway is that fixing this doesn't mean pulling back on Furniture — it means putting a discount approval limit on a specific set of products and regions.
